...
<html lang="en" data-bs-theme="light">
  <head>
    ...
    <link href="/docs/5.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
        ...
        <!-- Favicons -->
    <link rel="apple-touch-icon" href="https://cdn.jsdelivr.net/docs/5.3/assets/img/favicons/apple-touch-icon.png" sizes="180x180">
    <link rel="icon" href="https://cdn.jsdelivr.net/docs/5.3/assets/img/favicons/favicon-32x32.png" sizes="32x32" type="image/png">
    <link rel="icon" href="https://cdn.jsdelivr.net/docs/5.3/assets/img/favicons/favicon-16x16.png" sizes="16x16" type="image/png">
    <link rel="manifest" href="https://cdn.jsdelivr.net/docs/5.3/assets/img/favicons/manifest.json">
    <link rel="mask-icon" href="https://cdn.jsdelivr.net/docs/5.3/assets/img/favicons/safari-pinned-tab.svg" color="#712cf9">
    <link rel="icon" href="https://cdn.jsdelivr.net/docs/5.3/assets/img/favicons/favicon.ico">
    ...
    <div class="container-fluid">
      <div class="row">
          ...
          <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
            ...
            <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
              <ul class="nav flex-column">
                ...
                <li class="nav-item">
                  <a class="nav-link d-flex align-items-center gap-2" href="/group">
                    Group Telegram
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link d-flex align-items-center gap-2" href="/pesan">
                    Template Pesan
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link d-flex align-items-center gap-2" href="/broadcast-pesan">
                  Broadcast Pesan
                  </a>
                </li>
              </ul>
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          ...
          <canvas class="my-4 w-100" id="myChart" width="406" height="171" style="display: block; box-sizing: border-box; height: 171px; width: 406px;"></canvas>
